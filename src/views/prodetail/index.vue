  ...
  <div class="prodetail">
    ...
    <div class="comment">
      <div class="comment-title">
        <div class="left">商品评价 ({{ totalContent }}条)</div>
        <div class="right">查看更多 <van-icon name="arrow" /> </div>
      </div>
      <div class="comment-list">
        <div class="comment-item" v-for="item in contentList" :key="item.comment_id">
          <div class="top">
...
export default {
  ...
  methods: {
    ...
    async getDetail () {
      const { data: { detail } } = await getProDeatil(this.goodsId)
      this.detail = detail
      this.images = detail.goods_images
    },
    async getContent () {
      const { data: { list, total } } = await getProContent(this.goodsId)
